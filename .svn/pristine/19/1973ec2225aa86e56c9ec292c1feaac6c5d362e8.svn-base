...
namespace Typo.View
{
    ...
    public partial class MainMenu : UserControl
    {
        ...
        public MainMenu(MainWindow mainWindow)
        {
            ...
            InitializeComponent();
            var MenuStatistics =
                new MenuStudentStatistics(mainWindow, (int) Application.Current.Properties["ActiveUserID"]);
            MenuStatistics.StatisticsGrid.Children.Remove(MenuStatistics.StatisticsGrid);
            MenuStatisticsGrid.Children.Add(MenuStatistics);
        }
        ...
        private void Start_GeneratedExercise_Click(object sender, RoutedEventArgs e)
        {
            mainWindow.NewView(new ExerciseView(mainWindow, ExerciseType.Generated));
        }

        private void Start_CharacterExercise_Click(object sender, RoutedEventArgs e)
        {
            mainWindow.NewView(new CharacterPicker(mainWindow));
        }
        ...
        private void Explanation_Click(object sender, RoutedEventArgs e)
        {
            ...
            mainWindow.MainFrame.Content = new TypingExplanation(mainWindow);
        }
    }
}